...
PentaHardwarePWM::PentaHardwarePWM(uint8_t motorPin1,
                                   uint8_t motorPin2,
                                   uint8_t servoPin1,
                                   uint8_t servoPin2,
                                   uint8_t servoPin3)
...
void PentaHardwarePWM::begin(uint32_t motorFrequency,
...
void PentaHardwarePWM::configureTimer(Tcc* timer,
                                      uint8_t gclk_id,
                                      uint32_t frequency)
{
    GCLK->CLKCTRL.reg =
...
void PentaHardwarePWM::setDutyCycle(Tcc* timer,
                                    uint8_t cc_channel,
                                    float percent)
{
    if (!timer)
...
// void PentaHardwarePWM::setDuty13(float percent)
// { // 13
//     setDutyCycle(_motorTimer, 0, percent);
// }

// void PentaHardwarePWM::setDuty11(float percent)
// { // 11
//     setDutyCycle(_motorTimer, 1, percent);
// }

void PentaHardwarePWM::setDuty13(float percent)
{ // D13 -> PA17 -> TCC2/WO[1] -> CC channel 1
    setDutyCycle(_motorTimer, 1, percent);
}

void PentaHardwarePWM::setDuty11(float percent)
{ // D11 -> PA16 -> TCC2/WO[0] -> CC channel 0
    setDutyCycle(_motorTimer, 0, percent);
}

void PentaHardwarePWM::setDuty12(float percent)
{ // D12 -> PA19 -> TCC0/WO[3] -> CC channel 3
    setDutyCycle(_servoTimer, 3, percent);
}

void PentaHardwarePWM::setDuty6(float percent)
{ // D6  -> PA20 -> TCC0/WO[6] -> CC channel 2
    setDutyCycle(_servoTimer, 2, percent);
}

void PentaHardwarePWM::setDuty5(float percent)
{ // D5  -> PA15 -> TCC0/WO[5] -> CC channel 1
