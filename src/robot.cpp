...
void setup() {
    ...
    scheduler.registerPacketHandler(0x01, EventPriority::PRIORITY_HIGH, RobotHandler::onThrottleReceived, &robotHandler);
    scheduler.registerPacketHandler(0x02, EventPriority::PRIORITY_HIGH, RobotHandler::onSteeringReceived, &robotHandler);
    scheduler.registerPacketHandler(0x06, EventPriority::PRIORITY_LOW,  RobotHandler::onMessageReceived, &robotHandler);
